...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/admin_assets/fonts/tabler-icons.min.css') }}">
    <!-- [Feather Icons] https://feathericons.com -->
    <link rel="stylesheet" href="{{ url('/admin_assets/fonts/feather.css') }}">
    <!-- [Font Awesome Icons] https://fontawesome.com/icons -->
    <link rel="stylesheet" href="{{ url('/admin_assets/fonts/fontawesome.css') }}">
    <!-- [Material Icons] https://fonts.google.com/icons -->
    <link rel="stylesheet" href="{{ url('/admin_assets/fonts/material.css') }}">
    <!-- [Template CSS Files] -->
    <link rel="stylesheet" href="{{ url('/admin_assets/css/style.css') }}"id="main-style-link">
...
<body>
    ...
    <!-- [ Pre-loader ] End -->
    <form id = "signupForm" action="{{ route('register.new.user') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="auth-main">
            <div class="auth-wrapper v3">
                <div class="auth-form">
                    <div class="auth-header">
                        <a href="#"><img src="{{ url('/admin_assets/images/logo-dark.svg') }}" alt="img"></a>
                    </div>
                    <div class="card my-5">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-end mb-4">
                                <h3 class="mb-0"><b>Sign up</b></h3>
                                <a href="{{ route('user.login') }}" class="link-primary">Already have an account?</a>
                            </div>
                            <div class="row">
                                <div class="col-12">
    ...
    <!-- [ Main Content ] end -->
    <!-- Required Js -->
    <script src="{{ url('/admin_assets/js/plugins/popper.min.js') }}"></script>
    <script src="{{ url('/admin_assets/js/plugins/popper.min.js') }}"></script>
    <script src="{{ url('/admin_assets/js/plugins/popper.min.js') }}"></script>
    <script src="{{ url('/admin_assets/js/plugins/popper.min.js') }}"></script>
    <script src="{{ url('/admin_assets/js/plugins/popper.min.js') }}"></script>
