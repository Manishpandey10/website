...
<body>
    ...
    <form method="POST" action="{{ route('verify.user.login') }}" id="loginForm">
            ...
            <div class="auth-wrapper v3">
                <div class="auth-form">
                    <div class="auth-header">
                        <a href="#"><img src="{{ url('/admin_assets/assets/images/logo-dark.svg') }}"
                                alt="img"></a>
                    </div>
                    <div class="card my-5">
                        <div class="card-body">
                           ...
                           <span id="alert_msg" class="mx-6 mb-2 text-success">
                            ...
                            <div class="d-flex justify-content-between align-items-end mb-4">
                                ...
                                <h3 class="mb-0"><b>User's Login</b></h3>
                            </div>
                ...
                <label class="form-check-label text-muted" for="customCheckc1">Keep me sign in</label>
                            ...
                            <div class="mb-2 mt-3">
                                ...
                                <a href="{{ route('register.user.page') }}" class="link-primary">Don't have an account? Sign up here.</a>
                            </div>
                            <div class="mb-2 mt-3">

                                <a href="{{ route('home') }}" class="link-primary">Go To Home Page</a>
                            </div>
                        </div>
                    </div>
