    ...
    <div class="pc-container">
        <div class="pc-content">
            <div class="card mx-4 mt-6">
                ...
                <h5 class="card-header">Manage HSN</h5>
                ...
                <div class="card-body shadow p-3 bg-white rounded">
                    ...
                    <button type="button" class=" btn btn-light " id="edit" name="edit"
                        style="background-color:rgb(252, 98, 41) !important;"><a href="{{ route('add.hsn') }}"
                            class="link-light">Add HSN</a>
                    </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class=" btn btn-primary edit-btn" name="edit">
                                                <a href="{{ route('edit.hsn', $data->id) }}" class=" link link-light">
                                                    Edit
                                                </a>
                                            </button>&nbsp;&nbsp;
        ...
        <script>
            $(document).ready(function() {
                $('#product-table').DataTable({
                    ...
                    "ordering": true,
                    language: {
                    searchPlaceholder: 'Search for HSN code ...' // Set your desired placeholder text here
                },
                    "info": true,
                    "autoWidth": false,
                    "responsive": true
