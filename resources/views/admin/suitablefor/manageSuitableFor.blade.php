    ...
    <div class="pc-container">
        <div class="pc-content">
            <div class="card mx-4 mt-6">
                ...
                <h5 class="card-header">Manage Suitable For </h5>
                ...
                <div class="card-body shadow p-3 bg-white rounded">
                    ...
                    <button type="button" class=" btn btn-light " id="edit" name="edit"
                        style="background-color:rgb(252, 98, 41) !important;"><a href="{{ route('add.suitable.for') }}"
                            class="link-light">Add Suitable for</a>
                    </button>
                    ...
                    <div class="table-responsive text-nowrap mt-3">
                        <table class="table table-bordered" id="product-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($suitabledata as $data)
                                    <tr>
                                        <td>
                                            <img src="{{ url('SuitableFor/' . $data->thumbnail) }}" width="85px"
                                        ...
                                        <td>
                                            <button type="button" class=" btn btn-primary edit-btn" name="edit">
                                                <a href="{{ route('edit.suitable.for', $data->id) }}""
        ...
        <script>
            $(document).ready(function() {
                $('#product-table').DataTable({
                    ...
                    "ordering": true,
                    language: {
                    searchPlaceholder: 'Search for suitable for....' // Set your desired placeholder text here
                },
                    "info": true,
                    "autoWidth": false,
                    "responsive": true
