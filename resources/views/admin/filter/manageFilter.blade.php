            ...
            <div class="card mx-4 mt-6">
                ...
                <div class="card-body shadow p-3 bg-white rounded">
                    ...
                    <button type="button" class=" btn btn-light " id="edit" name="edit"
                        style="background-color:rgb(252, 98, 41) !important;"><a href="{{ route('add.filter') }}"
                            class="link-light">Add new Filter</a>
                    </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class=" btn btn-primary edit-btn" name="edit">
                                                <a href="{{ route('edit.filter', $data->id) }}" class=" link link-light">
                                                    Edit
                                                </a>
                                            </button>&nbsp;&nbsp;

                                            <button type="button" class=" btn btn-primary ">
                                                <a href="{{ route('delete.filter', $data->id) }}"
        ...
        <script>
            $(document).ready(function() {
                $('#product-table').DataTable({
                    ...
                    "ordering": true,
                    language: {
                    searchPlaceholder: 'Search for filter....' // Set your desired placeholder text here
                },
                    "info": true,
                    "autoWidth": false,
                    "responsive": true
