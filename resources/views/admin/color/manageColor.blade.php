    ...
    <div class="pc-container">
        <div class="pc-content">
            <div class="card mx-4 mt-6">
                ...
                <h5 class="card-header">Manage Color </h5>
                ...
                <div class="card-body shadow p-3 bg-white rounded">
                    ...
                    <button type="button" class=" btn btn-light " id="edit" name="edit"
                        style="background-color:rgb(252, 98, 41) !important;"><a href="{{ route('add.color') }}"
                            class="link-light">Add new color</a>
                    </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class=" btn btn-primary edit-btn" name="edit">
                                                <a href="{{ route('edit.color', $data->id) }}"" class=" link link-light">
                                                    Edit
                                                </a>
                                            </button>&nbsp;&nbsp;
        ...
        <script>
            $(document).ready(function() {
                $('#product-table').DataTable({
                    ...
                    "info": true,
                    language: {
                    searchPlaceholder: 'Search for color....' // Set your desired placeholder text here
                },
                    "autoWidth": false,
                    "responsive": true
                });
