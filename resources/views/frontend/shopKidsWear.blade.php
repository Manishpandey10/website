            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9">
                                ...
                                <div class="card position-relative h-100 card-listing hover-trigger">
                                    <div class="card-header">
                                        @php
                                            ...
                                            $img = $kidswear->firstVariantImage?->name;
                                            $imgPath =
                                    ...
                                    <div class="card-body px-0 text-center">
                                        ...
                                        <a class="mb-0 mx-2 mx-md-4 fs-p  text-decoration-none d-block text-center"
                                            href="{{ route('product.details', ['product_id' => $kidswear->id, 'color_id' => $kidswear->firstVariant?->color_id]) }}">
                                            {{ $kidswear->name }}</a>
                                        <p class="lead fw-bolder m-0 fs-3 lh-1 text-danger me-2">Rs.
                                            {{ $kidswear->firstVariant?->price - $kidswear->firstVariant?->discountedPrice }}
                                        </p>
                                        <s class="lh-1 me-2"><span class="fw-bolder m-0">Rs.
                                                {{ $kidswear->firstVariant?->price }}</span></s>
                                        (<span>{{ $kidswear->firstVariant?->discount }}% off</span>)
                                        <p class="lead fw-bolder m-0 fs-6 lh-1 text-success">Save Rs.
                                            {{ $kidswear->firstVariant?->discountedPrice }}</p>
                                    </div>
                                </div>
                                <!--/ Card Product-->
                            </div>
                    ...
                    <nav class="border-top mt-5 pt-5 d-flex justify-content-between align-items-center"
                        ...
                        <ul class="pagination">
                            {{-- <div class=" mt-4">
                                {{ $kidswear->links('pagination::bootstrap-5') }}
                            </div> --}}
                        </ul>
                    </nav> <!-- / Pagination-->
