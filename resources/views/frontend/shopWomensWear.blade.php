        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <!-- Top Toolbar-->
                    {{-- <div class="mb-4 d-md-flex justify-content-center align-items-center">
                                ...
                                <div class="card position-relative h-100 card-listing hover-trigger">
                                    <div class="card-header">
                                        @php
                                            ...
                                            $img = $womenwear->firstVariantImage?->name;
                                            $imgPath =
                                    ...
                                    <div class="card-body px-0 text-center">
                                        ...
                                        <a class="mb-0 mx-2 mx-md-4 fs-p  text-decoration-none d-block text-center"
                                            href="{{ route('product.details', ['product_id' => $womenwear->id, 'color_id' => $womenwear->firstVariant->color_id]) }}">
                                            {{ $womenwear->name }}</a>
                                        <p class="lead fw-bolder m-0 fs-3 lh-1 text-danger me-2">Rs.
                                            {{ $womenwear->firstVariant?->price - $womenwear->firstVariant?->discountedPrice }}
                                        </p>
                                        <s class="lh-1 me-2"><span class="fw-bolder m-0">Rs.
                                                {{ $womenwear->firstVariant?->price }}</span></s>
                                        (<span>{{ $womenwear->firstVariant?->discount }}% off</span>)
                                        <p class="lead fw-bolder m-0 fs-6 lh-1 text-success">Save Rs.
                                            {{ $womenwear->firstVariant?->discountedPrice }}</p>
                                    </div>
                                </div>
                                <!--/ Card Product-->
                            </div>
                    ...
                    {{-- <nav class="border-top mt-5 pt-5 d-flex justify-content-between align-items-center"
                        ...
                        <ul class="pagination">
                            <div class=" mt-4">
                                {{ $womenswear->links('pagination::bootstrap-5') }}
                            </div>
                        </ul>
                    </nav> 
                    <!-- / Pagination--> --}}
