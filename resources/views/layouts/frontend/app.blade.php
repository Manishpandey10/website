...
<head>
    ...
    <link rel="preconnect" href="{{ url('https://fonts.googleapis.com') }}" crossorigin>
    <link href="{{ url('https://fonts.googleapis.com/css2?family=Barlow:wght@300;400;500;600;700&display=swap') }}"
        rel="stylesheet">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-12 col-lg-7">
                                                <div class="row py-lg-5">
                                                    ...
                                                    @foreach ($mensCategory as $category)
                                                        <div class="col col-lg-6 mb-5 mb-sm-0">
                                                            <h6 class="dropdown-heading">{{ $category->name }}</h6>
                                                                ...
                                                                @if (count($category->subcategory))
                                                                    <li class="dropdown-list-item">
                                                                        <a class="dropdown-item dropdown-link-all"
                                                                            href="{{ route('menswear.product.list') }}">
                                                                            {{-- href="{{ route('product.details', $category->id) }}"> --}}
                                                                            View All
                                                                        </a>
                                                                    </li>
                                                                @endif
                                                    ...
                                                    <div class="col col-lg-6">
                                                        <h6 class="dropdown-heading">Brands <span
                                                                class="text-small text-danger">
                                                                (*this is static only for testing purpose)
                                                            </span>
                                                        </h6>
                                                        <ul class="list-unstyled">
                                                            ...
                                                            {{-- <li class="dropdown-list-item"><a
                                                                    ...
                                                                    href="{{ route('product.list') }}">View All</a>
                                                            </li> --}}
                                                        </ul>
                                                    </div>
                                                    <!-- /menu row-->
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-12 col-lg-7">
                                                <div class="row py-lg-5">
                                                    ...
                                                    @foreach ($womensCategory as $category)
                                                        <div class="col col-lg-6 mb-5 mb-sm-0">
                                                            <h6 class="dropdown-heading">{{ $category->name }}</h6>
                                                            <ul class="list-unstyled">
                                                                @foreach ($category->subcategory as $sub)
                                                                ...
                                                                @if (count($category->subcategory))
                                                                    <li class="dropdown-list-item">
                                                                        <a class="dropdown-item dropdown-link-all"
                                                                            href="{{ route('womenswear.product.list') }}">
                                                                            {{-- href="{{ route('product.details', $category->id) }}"> --}}
                                                                            View All
                                                                        </a>
                                                                    </li>
                                                    ...
                                                    <!-- menu row-->
                                                    <div class="col col-lg-6">
                                                        <h6 class="dropdown-heading">Brands
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-12 col-lg-7">
                                                <div class="row py-lg-5">
                                                    ...
                                                    @foreach ($kidsCategory as $category)
                                                        <div class="col col-lg-6 mb-5 mb-sm-0">
                                                            <h6 class="dropdown-heading">{{ $category->name }}</h6>
                                                            <ul class="list-unstyled">
                                                                @foreach ($category->subcategory as $sub)
                                                                ...
                                                                @if (count($category->subcategory))
                                                                    <li class="dropdown-list-item">
                                                                        <a class="dropdown-item dropdown-link-all"
                                                                            href="{{ route('kidswear.product.list') }}">
                                                                            {{-- href="{{ route('product.details', $category->id) }}"> --}}
                                                                            View All
                                                                        </a>
                                                                    </li>
                                            ...
                                            <div class="d-none d-lg-block col-lg-5">
                                                <div class="vw-50 h-100 bg-img-cover bg-pos-center-center position-absolute"
                                                    style="background-image: url(./assets/images/banners/instagram-3.jpg);">
                                                </div>
                                            </div>
                                            <!-- Dropdown Menu Images Section-->
                                        </div>
                    ...
                    <ul class="list-unstyled mb-0 d-flex align-items-center">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li>
                                    <a class="dropdown-item" href="#">
                                        ...
                                        @else
                                            Please login for better and smooth ordering experience
                                        @endif
                                    </a>
                                </li>
                                <li>
                                    ...
                                    <li>
                                        <a href="{{ route('view.order') }}">
                                            <button type="submit" class="dropdown-item text-danger">
                                                <i class="ri-logout-box me-2"></i> View Orders
                                            </button>
                                        </a>
                                        <a href="{{ route('user.logout') }}">
                                            <button type="submit" class="dropdown-item text-danger">
                                                <i class="ri-logout-box me-2"></i> Logout
                                            </button>
                                        </a>
                                    </li>
                                @else
                                    <!-- Login / Signup -->
                                    <li>
                                        <a class="dropdown-item text-success" href="{{ route('user.login') }}">
                                            <i class="ri-login-box-line me-2"></i> Login / Sign Up
                                        </a>
                                    </li>
                                @endif
                            </ul>
                        ...
                        <li class="ms-1 d-inline-block position-relative">
                            <button
                                ...
                                <span
                                    class="cart-count fs-xs fw-bolder f-w-5 f-h-5 bg-orange rounded-lg d-block lh-1 pt-1 position-absolute top-0 end-0 z-index-20 mt-2 text-white">{{ $count }}</span>
                            </button>
                        </li>
                        <!-- /Navbar Cart-->
        ...
        <div class="bg-light py-4">
            <div class="container d-flex justify-content-center align-items-center py-2">
                ...
                <ul class="list-unstyled d-flex justify-content-start align-items-center mb-0 ms-3 lh-1">
                    ...
                    <li class="mx-1 mb-0 lh-1"><a
                            class="text-muted text-decoration-none opacity-75-hover transition-all lh-1"
                            href="#"><i class="ri-facebook-fill ri-xl lh-1"></i></a></li>
                    <li class="mx-1 mb-0 lh-1"><a
                            class="text-muted text-decoration-none opacity-75-hover transition-all lh-1"
                            href="#"><i class="ri-twitter-fill ri-xl lh-1"></i></a></li>
                    <li class="mx-1 mb-0 lh-1"><a
                            class="text-muted text-decoration-none opacity-75-hover transition-all lh-1"
                            href="#"><i class="ri-snapchat-fill ri-xl lh-1"></i></a></li>
                </ul>
            </div>
        </div>
        <!-- / Footer socials-->
                ...
                <div class="col-12 col-md-4 mb-3 mb-xxl-0 text-white" data-aos="fade-left">
                    <div
                        ...
                        <div class="ms-lg-4">
                            ...
                            <small class="text-muted"><a class="text-muted" href="#">Click here</a> to chat
                                with our support team</small>
                        </div>
                    </div>
                </div>
                <!-- / Info box-->
        ...
        <div class="border-top-white-opacity py-7 mt-7 text-white">
            <div class="container" data-aos="fade-in">
                <div class="row my-4 flex-wrap">
                    ...
                    <nav class="col-6 col-md mb-4 mb-md-0">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2"><a
                                    ...
                                    href="{{ route('menswear.product.list') }}">Menswear</a></li>
                            <li class="mb-2"><a
                                    class="text-decoration-none text-white opacity-75 opacity-25-hover transition-all"
                                    href="{{ route('womenswear.product.list') }}">Womenswear</a></li>
                            <li class="mb-2"><a
                                    class="text-decoration-none text-white opacity-75 opacity-25-hover transition-all"
                                    href="{{ route('kidswear.product.list') }}">Kidswear</a></li>
                            <li class="mb-2"><a
                                    class="text-decoration-none text-white opacity-75 opacity-25-hover transition-all"
                                    href="{{ route('accessories.product.list') }}">New Arrivals</a></li>
                        </ul>
                    </nav>
                    <!-- /Footer Nav-->
                    ...
                    <nav class="d-none d-md-block col-md">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2"><a
                                    class="text-decoration-none text-white opacity-75 opacity-25-hover transition-all"
                                    href="{{ route('register.user.page') }}">Register</a></li>
                            <li class="mb-2"><a
                                    class="text-decoration-none text-white opacity-75 opacity-25-hover transition-all"
                ...
                <div
                    ...
                    <p class="small opacity-75">&copy; 2025 Manish All Rights Reserved. Template by <a
        ...
        <div class="offcanvas-body">
            <div class="d-flex flex-column justify-content-between w-100 h-100">
                <div id="offcanvasbody">
                    @if ($cartdata->count() == 0)
                        <span id="alert_msg" class="text-danger mt-6 mb-4 ">
                            There are no products in cart right now, all products selected for shopping will be
                            displayed in cart.
                        </span>
                    @endif
                    <!-- Cart Product-->
                        ...
                        <div class="row mx-0 pb-4 mb-4 border-bottom">
                            <div class="col-3">
                                <picture class="d-block bg-light">
                                    <img class="img-fluid"
                                        src="{{ url('variantThumbnail/' . $item->options->image?->name) }}"
                            ...
                            <div class="col-9">
                                <div>
                                    ...
                                    <small class="d-block text-muted fw-bolder">Size:
                                        {{ $item->options->size }}</small>
                                    <span class="small text-muted mr-2 fw-bolder">
                                        Discount:
                                        {{ $item->options->Variantdata?->discount }} %
                                    </span>
                                    <small class="d-block text-muted fw-bolder">Qty: {{ $item->qty }}</small>
                                    <span class="small text-muted mr-2 fw-bolder">
                                        Actual Price:
                                        {{ $item->options->Variantdata?->price }}
                                    </span>
                                </div>
                                <p class="fw-bolder text-end m-0">Your Price: Rs.{{ $item->price }}</p>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="border-top pt-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <p class="m-0 fw-bolder">Rs. {{ $subtotal }}</p>
                    </div>
                        ...
                        <nav>
                            <ul class="list-unstyled list-default-text">
                                ...
                                <li class="mb-2"><a
                                        class="text-decoration-none text-body text-secondary-hover transition-all d-flex justify-content-between align-items-center"
                                        href="#"><span><i class="ri-arrow-right-s-line align-bottom ms-n1"></i>
                                            Down Jackets</span> <span class="text-muted ms-4">(13)</span></a>
                                </li>
                                <li class="mb-2"><a
                                        class="text-decoration-none text-body text-secondary-hover transition-all d-flex justify-content-between align-items-center"
                                        href="#"><span><i class="ri-arrow-right-s-line align-bottom ms-n1"></i>
